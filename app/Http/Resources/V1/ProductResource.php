...
class ProductResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'price'         => $this->price,
            'compare_price' => $this->when(isset($this->compare_price), $this->compare_price),
            'stock'         => $this->when(isset($this->stock), $this->stock), 
            'is_available'  => $this->is_available,
            'is_feature'    => $this->when(isset($this->is_feature), $this->is_feature),
            'relevance'     => $this->when(isset($this->relevance), $this->relevance),
