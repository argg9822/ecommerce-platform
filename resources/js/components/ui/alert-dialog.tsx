...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Action
    ...
    className={cn(
      ...
      "bg-red-600 hover:bg-red-700 focus-visible:ring-red-900 text-white",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Cancel
    ...
    className={cn(
      ...
      "mt-0 bg-transparent hover:bg-gray-700 border-gray-600 text-gray-200 hover:text-gray-100",
      className
    )}
    {...props}
  />
